      ...
      >
        ...
        <form onSubmit={handleCustomSubmit} className="flex items-center gap-2 pt-1 border-t border-white/10">
          ...
          <button
            ...
            className="px-4 py-2.5 rounded-xl bg-white text-black font-semibold text-xs transition-all hover:scale-105 active:scale-95 disabled:opacity-40 disabled:hover:scale-100 shadow-sm"
          >
            Set
          </button>
        </form>
