...
export const CreatePlaylistModal: React.FC<CreatePlaylistModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 bg-black/70 backdrop-blur-md animate-in fade-in duration-200">
      <div className="relative w-full max-w-md rounded-2xl glass-modal border border-white/10 p-6 shadow-2xl animate-in zoom-in-95 duration-200">
        <button
          onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex items-center justify-end gap-3 mt-4">
            ...
            <button
              ...
              className="px-5 py-2 rounded-xl text-sm font-medium bg-white hover:bg-neutral-100 disabled:opacity-50 text-black transition-all duration-200 ease-out-expo shadow-play-btn"
            >
